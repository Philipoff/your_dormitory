<template>
  <div>
    <button class="dorm-add-fav-button" @click.stop="onClickFav()">
      <svg class="dorm-add-fav-button__svg" id='favSvg' width="35" height="35" viewBox="0 0 35 35" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div class="dorm-add-fav-button__title">
        <slot></slot>
      </div>
    </button>
  </div>
...
export default {
  ...
  methods: {
    onClickFav(){
      ...
      const favSvg = document.getElementById('favSvg')
      if (this.isFavourite) {
